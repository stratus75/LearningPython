...
Based on the user's guess, the program should determine a winner. If the user's
...
def roll_dice(number_of_sides):
    ...
    if user_guess > max_val:
        ...
        if user_guess > total_roll:
            print('You have one! dice rolled %d and your guess was %d' %
                  (total_roll, user_guess))
            return
        else:
